...
public class HibernateConfiguration {
		...
		private final static String JDBC_URL = "jdbc:h2:tcp://localhost/~/sinu";
	    ...
	    @Bean
	    public HibernateTransactionManager getTtransactionManager(SessionFactory sessionFactory) {
